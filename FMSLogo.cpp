    ...
    )
{
    ...
    if (*CurrentArgument != '\0')
    {
		...
		//TODO: not working on wxWidgets is UNICODE and this project is MBCS

        //numericValue = strtoul(WXCHAR_TO_STRING(CurrentArgument), &CurrentArgument, 10);
    }
    else
    {
        ...
        if (nextArgument != NULL)
        {
            ...
            numericValue = strtoul(WXCHAR_TO_STRING(nextArgument), NULL, 10);
            NextArgument++;
        }
        else
        {
...
void CFmsLogo::ProcessCommandLine()
{
         ...
         nextArgument++)
    {
        ...
        if (copyRemaingArgsAsFilename)
        {
            ...
            fileToLoadIndex += strlen(WXCHAR_TO_STRING(argument));
        }
    }
...
bool CFmsLogo::OnInit()
{
    ...
    g_SingleInstanceMutex = CreateMutexA(
    ...
    if (GetLastError() == ERROR_ALREADY_EXISTS)
    {
        ...
        if (g_FileToLoad[0] == '\0')
        {
            ...
            HWND runningInstance = FindWindowA(NULL, LOCALIZED_GENERAL_PRODUCTNAME);
