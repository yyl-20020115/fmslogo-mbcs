...
#define LOCALIZED_FILE_NEW              "Nowy\t(czyœci przestrze?robocz?" // &New\t(erase workspace)
#define LOCALIZED_FILE_LOAD             "Za³aduj...\t(do³¹cza do przestrzeni roboczej)" // &Load...\t(merge into workspace)
#define LOCALIZED_FILE_OPEN             "Otwórz...\t(zastêpuje przestrze?robocz?" //&Open...\t(replace workspace)
...
#define LOCALIZED_EDITOR_SEARCH_NEXT             "Znajd?nastêpny\tF3" // &Next\tF3
...
#define LOCALIZED_UNSAVEDCHANGES_MESSAGE1       "Przestsze?robocza zawiera niezapisane zmiany. Jeœli wyjdziesz bez zapisu, to zmiany te zostan?utracone." // There are unsaved changes in the workspace. If you exit without saving, these changes will be lost.
#define LOCALIZED_UNSAVEDCHANGES_MESSAGE2       "Czy chcesz zapisa?zmiany przed wyjœciem?" // Would you like to save your changes before exiting?
...
#define LOCALIZED_ERASEPROCEDURE                "Wyczyœæ procedur? // Erase Procedure
